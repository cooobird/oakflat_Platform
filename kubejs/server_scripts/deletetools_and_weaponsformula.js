onEvent('recipes', event => {
    ...
    event.remove({output:'natural-progression:basic_saw'})
    event.remove({output:'natural-progression:golden_saw'})
    event.remove({output:'natural-progression:diamond_saw'})
    event.remove({output:'natural-progression:netherite_saw'})
    event.remove({output:'natural-progression:copper_saw'})
    event.remove({output:'natural-progression:bronze_saw'})
    event.remove({output:'natural-progression:steel_saw'})
